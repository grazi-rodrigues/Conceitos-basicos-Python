...
#Importando a penas a biblioteca express (mais rápida), que permite faça as coisas mais simplificada
...
# datasets/customer reviews.csv

df_reviews = pd.read_csv("\Projetos-Python\Projeto web básico\datasets\customer reviews.csv")
...
# Criando Gráficos
# .bar é um plotly do tipo bar
fig = px.bar(df_books["year of publication"].value_counts())
# Método px.histogram criará um histograma e calcula automaticamente
fig2 = px.histogram(df_books["book price"])

# Função st.colmns() devolve duas váriaies ao mesmo tempo
